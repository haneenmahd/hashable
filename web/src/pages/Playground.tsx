...
const Sidebar: Component<{
  ...
  <div class="p-5 z-20 w-screen md:w-auto h-[30vh] md:h-auto order-last md:order-first">
    <div class="min-w-[16rem] max-h-[230px] md:max-h-[80vh] overflow-scroll md:overflow-auto md:h-[90vh] rounded-md ring-1 ring-slate-200 shadow-lg bg-slate-100">
      <div class="py-2">
...
const Main: Component<{
  ...
  return (
    <div class="w-[100%] h-[60vh] md:h-[100vh] bg-white flex flex-col items-center justify-center">
      <QuickActions
        value={value}
      ...
      <div class="flex flex-col items-center justify-center">
        <input
          class="max-w-[80%] md:max-w-[100%] bg-transparent my-4 text-center font-semibold text-3xl md:text-5xl text-slate-800 outline-none focus:placeholder:text-slate-300"
          placeholder="Type string to hash...."
          value={value()}
          onChange={(e) => setValue((e.target as HTMLInputElement).value)}
        />

        <span class="max-w-[80%] break-all text-center my-4 font-semibold slashed-zero text-xl md:text-2xl text-slate-500 outline-none focus:placeholder:text-slate-300">
          <p>{hash()}</p>
        </span>
      </div>
      ...
      <div class="mt-12 hidden md:visible">
...
const Playground: Component = () => {
  ...
  return (
    <div>
      {loaded() ? (
        <div class="flex flex-col md:flex-row items-center playground-load-animation">
